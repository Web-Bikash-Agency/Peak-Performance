...
//     profilePicture: '',
//     status: 'ACTIVE' // ✅ Use database format
//   });

//   // ✅ Reset form data when editingMember changes
//   useEffect(() => {
//     if (editingMember) {
//       console.log("🔧 EDIT MODE - Loading member data:", editingMember);
//       setFormData({
//         name: editingMember.name || '',
...
//         phone: editingMember.phone || '',
//         membershipType: editingMember.membershipType || '',
//         expiryDate: editingMember.expiryDate ? new Date(editingMember.expiryDate) : null,
//         profilePicture: editingMember.profilePicture || '',
//         status: editingMember.status || 'ACTIVE' // ✅ Preserve original status
//       });
//     } else {
...
//       membershipType: formData.membershipType as Member['membershipType'],
//       expiryDate: formData.expiryDate as Date,
//       status: formData.status as Member['status'], // ✅ Use form status (preserves original for edits)
//       profilePicture: formData.profilePicture,
//       joinDate: editingMember?.joinDate || new Date()
//     };
...
//     // The parent will close the form after successful save
//   };
